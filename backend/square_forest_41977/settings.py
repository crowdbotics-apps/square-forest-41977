"""
Django settings for square_forest_41977 project.
...
ROOT_URLCONF = 'square_forest_41977.urls'
...
WSGI_APPLICATION = 'square_forest_41977.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "square_forest_41977 API",
    "DESCRIPTION": "API documentation for square_forest_41977 App",
    "VERSION": "v1",
}
